...
from of_methods import lucas_kanade, horn_schunck, lucas_kanade_pyramid

im1 = cv2.imread("./collision/00000001.jpg")
im1 = cv2.cvtColor(im1, cv2.COLOR_BGR2GRAY)
im2 = cv2.imread("./collision/00000005.jpg")
...
U_hs, V_hs = lucas_kanade_pyramid(im1, im2, 3)
#U_hs, V_hs = horn_schunck(im1, im2, 1000, 100)
